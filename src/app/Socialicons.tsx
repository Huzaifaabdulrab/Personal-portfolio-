...
export default function SocialIcon() {
  return (
    <>
      <div id="icons" className="box relative flex justify-between items-center  lg:w-[90%] md:w-[100%] w-[90%] lg:p-4 p-6  bg-[#e3e3e3] shadow-lg 
            bottom-0 mx-auto z-10 lg:-mt-6 -mt-16 sm:bg-[#e3e3e3] sm:border sm:border-gray-300 sm:bg-transparent lg:bg-[#e3e3e3] rounded-full md:rounded-l-full">

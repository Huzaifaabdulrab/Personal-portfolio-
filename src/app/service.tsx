...
export default function ServicesSection() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-10 px-20">
        {services.map((service, index) => (
          <SpotlightCard key={index} className="custom-spotlight-card" spotlightColor="#091057">
            <div
              className="shadow-xl rounded-lg p-6 flex flex-col items-center text-center min-h-[310px]"
